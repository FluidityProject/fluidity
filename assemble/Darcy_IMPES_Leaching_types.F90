...
#include "fdebug.h"
  ...
  type  leach_chemical_MIM_type
     ...
     type (scalar_field), pointer :: im_src !the chemical reaction src of the immobile part
     type (scalar_field), pointer :: mo_src !the chemical reaction src of the mobile part
