...
! ----------------------------------------------------------------------------
   ...
   subroutine darcy_impes_assemble_and_solve_part_two(di, di_dual, have_dual, have_dual_perm)
      ...
      call darcy_impes_assemble_and_solve_phase_pressures(di, di_dual, have_dual, have_dual_perm)
...
! ----------------------------------------------------------------------------
   ...
   subroutine darcy_impes_assemble_and_solve_phase_pressures(di, di_dual, have_dual, have_dual_perm)
      ...
      if (di%first_phase_pressure_prognostic) call darcy_impes_assemble_and_solve_first_phase_pressure(di, di_dual, have_dual, have_dual_perm)
...
! ----------------------------------------------------------------------------
   ...
   subroutine darcy_impes_assemble_and_solve_first_phase_pressure(di, di_dual, have_dual, have_dual_perm)
      ...
      !!< If have_dual and have_dual_perm are both true then a block matrix using 
      !!< di%dual_block_pressure_matrix is solved for. If have_dual is true but 
      !!< have_dual_perm is false then a single matrix using di%pressure_matrix 
