subroutine test_sam_integration_2d
  ...
  call load_options("data/sam_integration_2d.flml")
  call populate_state(states)

  mesh_ptr => extract_mesh(states(1), "VelocityMesh")
  call allocate(test_field_v, 2, mesh_ptr, "TestVector")
  call set(test_field_v, (/2.0, 3.0/))
  test_field_v%option_path = "/material_phase[0]/vector_field::TestVector"
  call set_option("/geometry/dimension", 2, stat=stat)
