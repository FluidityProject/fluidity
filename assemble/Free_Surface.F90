...
contains
  ...
  type(petsc_csr_matrix):: vertical_prolongator
    ...
    if (IsParallel()) then
      ...
      ewrite(2,*) "Number of columns in vertical prolongator:", size(csr_vertical_prolongator,2)
      if (size(csr_vertical_prolongator,2)>key_count(owned_surface_nodes)) then
