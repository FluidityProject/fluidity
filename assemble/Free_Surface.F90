...
contains
  ...
  !!< Momentum_Equation.F90
    ...
    type(scalar_field), optional, intent(inout) :: rhs
      ...
      integer, dimension(:), pointer:: surface_p_element_list
      ...
      logical:: addto_cmc, variable_density, any_variable_density
      logical:: have_density, use_hydrostatic_projection
  ...
  subroutine add_free_surface_to_poisson_rhs(poisson_rhs, state, dt, theta_pg)
    ...
    type(scalar_field), pointer:: p, topdis, free_surface, scaled_fs, density
    type(mesh_type), pointer:: surface_p_mesh, embedded_fs_mesh
    character(len=FIELD_NAME_LEN):: bctype
    character(len=OPTION_PATH_LEN):: fs_option_path
    real g, coef, rho0, delta_rho, rho_external
    integer, dimension(:), pointer:: surface_element_list, surface_p_element_list, fs_surface_element_list
    integer i, j, grav_stat, dens_stat
    logical:: include_normals
    logical:: implicit_prognostic_fs, use_fs_mesh, use_hydrostatic_projection
  ...
  type(vector_field), intent(in):: u
    ...
    type(scalar_field), pointer:: free_surface, topdis
    character(len=FIELD_NAME_LEN):: bctype
    type(integer_hash_table):: sele_to_surface_p_ele
