...
REAL, ALLOCATABLE, DIMENSION(:,:):: u,s
double precision, dimension(:, :), allocatable :: v
REAL, ALLOCATABLE, DIMENSION(:)::   workl,resid
double precision, dimension(:), allocatable :: ax, workd
...
REAL, ALLOCATABLE, DIMENSION(:)::   workl,resid
double precision, dimension(:), allocatable :: ax, workd
double precision, dimension(:), allocatable :: ay, ay_dx, ay_dy, ay_dz
logical, ALLOCATABLE, DIMENSION(:)::   select
logical ::D3
