...
def restresseslemoin(off):
    ...
    Le_uu4 = open(str(mydir) + "/Le-profiles/Le-profile1-uu-x4.dat").readlines()
    rs_uu4 = [off + float(line.split()[0]) for line in Le_uu4]
    y_uu4 = [float(line.split()[1]) for line in Le_uu4]
    Le_vv4 = open(str(mydir) + "/Le-profiles/Le-profile1-vv-x4.dat").readlines()
    rs_vv4 = [float(line.split()[0]) for line in Le_vv4]
    y_vv4 = [float(line.split()[1]) for line in Le_vv4]
    Le_uv4 = open(str(mydir) + "/Le-profiles/Le-profile1-uv-x4.dat").readlines()
    ...
    Le_uu6 = open(str(mydir) + "/Le-profiles/Le-profile1-uu-x6.dat").readlines()
    rs_uu6 = [off + float(line.split()[0]) for line in Le_uu6]
    y_uu6 = [float(line.split()[1]) for line in Le_uu6]
    Le_vv6 = open(str(mydir) + "/Le-profiles/Le-profile1-vv-x6.dat").readlines()
    rs_vv6 = [float(line.split()[0]) for line in Le_vv6]
    y_vv6 = [float(line.split()[1]) for line in Le_vv6]
    Le_uv6 = open(str(mydir) + "/Le-profiles/Le-profile1-uv-x6.dat").readlines()
    ...
    Le_uu10 = open(str(mydir) + "/Le-profiles/Le-profile1-uu-x10.dat").readlines()
    rs_uu10 = [off + float(line.split()[0]) for line in Le_uu10]
    y_uu10 = [float(line.split()[1]) for line in Le_uu10]
    Le_vv10 = open(str(mydir) + "/Le-profiles/Le-profile1-vv-x10.dat").readlines()
    rs_vv10 = [float(line.split()[0]) for line in Le_vv10]
    y_vv10 = [float(line.split()[1]) for line in Le_vv10]
    Le_uv10 = open(str(mydir) + "/Le-profiles/Le-profile1-uv-x10.dat").readlines()
    ...
    Le_uu19 = open(str(mydir) + "/Le-profiles/Le-profile1-uu-x19.dat").readlines()
    rs_uu19 = [off + float(line.split()[0]) for line in Le_uu19]
    y_uu19 = [float(line.split()[1]) for line in Le_uu19]
    Le_vv19 = open(str(mydir) + "/Le-profiles/Le-profile1-vv-x19.dat").readlines()
    rs_vv19 = [float(line.split()[0]) for line in Le_vv19]
    y_vv19 = [float(line.split()[1]) for line in Le_vv19]
    Le_uv19 = open(str(mydir) + "/Le-profiles/Le-profile1-uv-x19.dat").readlines()
