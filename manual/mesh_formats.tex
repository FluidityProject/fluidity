...
\lstinline[language=Bash]+create_aligned_mesh+ script which is part of \fluidity\ tools. 
More information can be found in section \ref{sect:create_aligned_mesh}.
...
\index{mesh!meshing tools!checkmesh}

This tool can be used to form a number of verification tests on a mesh
...
This tool converts ASCII Gmsh mesh files into triangle format. Whilst Fluidity
...
\lstinline[language = Bash]+gmsh2triangle+ instead. More information can be 
found in section~\ref{sect:gmsh2triangle}.

\subsection{interval}
\index{mesh!meshing tools!interval}
This tool generates a 1D mesh. 
More information can be found in section~\ref{sect:interval}.

\subsection{triangle2vtu}
\index{mesh!meshing tools!triangle2vtu}
This tool converts triangle format files into vtu format. 
More information can be found in section~\ref{sect:triangle2vtu}.
