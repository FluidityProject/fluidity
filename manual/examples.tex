...
In this example, \fluidity\ is used to replicate the conditions under which plumes of tephra particles form as well as the settling velocities of the individual particles and the plumes. The example demonstrates the following functionality:
\begin{itemize}
\item 2D flow
...
The simulation illustrated here took $\sim$? hours to run in parallel on 4 Intel Xeon ? ?.?? GHz processors.
...
\subsection{Results}
%Several timesteps of the example simulation can be seen in Figure \ref{fig:tephra_settling}. Similar images can be generated by visualising the vtu files using Paraview.

% \begin{figure}[H]
% 	\centering
% 		\includegraphics[scale=0.37]{./examples_images/tephra_settling/adaptive_1.pdf}
% 		\includegraphics[scale=0.37]{./examples_images/tephra_settling/adaptive_1.pdf}
% 		\includegraphics[scale=0.37]{./examples_images/tephra_settling/adaptive_1.pdf}
% 		\includegraphics[scale=0.37]{./examples_images/tephra_settling/adaptive_1.pdf}
% 		\includegraphics[scale=0.37]{./examples_images/tephra_settling/adaptive_1.pdf}
% 		\includegraphics[scale=1.0]{./examples_images/tephra_settling/legend.pdf}
%    \caption{Results from the \texttt{tephra\_settling} example at time $t=0.0, 0.6, 1.1, 1.5, 2.4$ seconds, with mesh adaptivity enabled. Initial resolution is concentrated around the interface between high and low tephra volume fractions, but the mesh adapts to accurately resolve the plumes being generated.}
