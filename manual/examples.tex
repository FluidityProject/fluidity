...
\begin{itemize}
\item Run from the checkpoint to look at the Froude number and mixing later in the simulation and calculate an average value, section \ref{sect:configuring_fluidity_checkpointing} (don't forget to rename the vtus with rename\_checkpoint.py, table \ref{tab:fltools});
