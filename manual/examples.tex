...
\centering
\begin{tabular}{llcl}
  example section & example directory & \hspace{-1cm}n/o procs. & run time \\
  \hline
  ...
  \ref{sect:flow_past_sphere} Flow past a sphere & \texttt{flow\_past\_a\_sphere/} & 8 & ?? \\
  ...
  \ref{sect:restratification_after_oodc} The restratification after OODC & \texttt{restratification\_after\_oodc/} & 32 & 12 hr. \\
...
For an overview of the estimated run time - using the default number of processors - for each
...
\item \option{\ldots/temporal\_discretisation/discontiunous\_galerkin/maximum\_courant\_number\_per\_subcycle} is on and set to 0.1.
