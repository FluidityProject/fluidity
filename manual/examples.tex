...
\begin{tabular}{|l|l|c|l|}
  ...
  \ref{sect:tephra_settling} Tephra settling & \texttt{tephra\_settling} & 4 & 1 hr. \\
  \hline
\end{tabular}
...
The experiments by Carey introduced tephra particles into the tank from above using a delivery system and a particle disperser; eventually, a layer of tephra formed on top of the water. This is represented here using a \option{flux} boundary condition at the top of the domain to allow tephra to flux in at a rate of $0.000472\ \mathrm{kgm^{-2}s^{-1}}$. The results of the experiments showed that tephra particles initially settled at an average Stokes velocity of $0.2\ \mathrm{cms^{-1}}$. When the concentration was high enough, plumes formed and travelled to the bottom of the tank at an average velocity of $2\ \mathrm{cms^{-1}}$ --- 10 times greater than that of single particles.
