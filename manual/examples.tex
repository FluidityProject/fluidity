...
\begin{tabular}{|l|l|c|l|}
  ...
  \ref{sec:backward_facing_step_2d} 2D Backward facing step & \texttt{backward\_facing\_step\_2d/} & 1 & 15 min. \\
  \ref{sec:backward_facing_step_3d} 3D Backward facing step & \texttt{backward\_facing\_step\_3d/} & 8 & 30 min. \\
...
\item Turn on metric advection, section \ref{section:metric_advection_general};
...
\begin{figure}
\centering
% Temporarily commented out following line so medium tests will run; please fix.
