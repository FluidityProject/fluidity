...
\begin{figure}[h!]
\begin{center}
{\includegraphics[width=10cm]{examples_images/restratification_after_oodc/mixing_stats.png}}
\label{fig:rousset-mixing}
\caption{Results of the mixing stats diagnostic, showing how the temperature is mixed during the simulation.}
\end{center}
\end{figure}
