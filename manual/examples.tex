...
\item Add the \option{Warp (scalar)} filter. Choose a normal direction of $0,1,0$ and click apply.
\item To visualise the grid points: add the \option{Glyph} filter; Choose \option{Glyph Type} \option{Sphere},
select the \option{Edit} checkbox next to \option{Set Scale Factor} and choose a value of 0.02; Click apply.
\end{itemize}
...
\begin{figure}
\centering
\fig[width=12.0cm]{examples_images/BackwardStep-schematic}
...
%\begin{figure}
%\centering
%\fig[width=12.0cm]{examples_images/backward_facing_step/BackwardStep-schematic.pdf}
...
5, 25 and 50 seconds. A vertical slice through the centre of the domain and a horizontal slice
at the level of the step are shown.


\begin{figure}
\centering
\subfigure{\fig[width=15.0cm]{examples_images/backward_facing_step/velo-vertplane-5sec}}
