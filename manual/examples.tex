...
It also makes use of mesh adaptivity. For the 2d case this means that \fluidity\ has be configured with the
\option{--enable-2d-adaptivity} flag. In 3d no extra flag is required.
