...
\begin{itemize}
  ...
  \item If the fields contain discontinuities (shocks or fronts), you can
    ...
    \option{\ldots/spatial\_discretisation/stabilisation} to stabilize the
    solution.
...
\begin{itemize}
  \item Under Velocity, the equation type should be set to
    ...
    of your domain as a prescibed \option{scalar\_field::BottomDepth} either
    using a \option{constant} or \option{python} function, or, to read from a netcdf
    file, use \option{from\_map}.
  ...
  \item Under \option{/physical\_parameters} you still need to set
    \option{gravtiy/magnitude}. The settings under
