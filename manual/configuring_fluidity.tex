...
\subsubsection{Multi-material compressible EOS}\label{Sect:Multi-material compressible EOS}
...
\end{align}
where $source$ is the explicitly calculated source term and $absorption$ is the explicitly calculated absorption term. Please note, it is not recommended to use the implicit option unless the simulation is very unstable.
...
The quarature degree is usually four in these case.
