...
and after adaptivity, which can be found under \option{mesh\_adaptivity/zoltan\_options}. In most cases the default
options should work fine. Each of the options and there functions are explained in detail in the schema.
