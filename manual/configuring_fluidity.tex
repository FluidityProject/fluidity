...
\end{equation}
where $f$ and $p$ denote the fluid (i.e. continuous) and particle (i.e. dispersed) phases respectively. The drag coefficient $C_D$ is:
...
Specifying the \option{../multiphase\_properties/particle\_diameter} option in a dispersed \option{matierial\_phase} enables fluid-particle interaction between itself and the continuous phase.
