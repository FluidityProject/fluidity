...
The GLSTurbulentKineticEnergy field must be solved before the GLSGenericSecondQuantity field for correct
calculation of the diffusivity and viscosity. In order for that to happen, the priority of the TKE field
must be higher than that of the second field. It is advised that setting to 100 for GLSTurbulentKineticEnergy and
99 for GLSGenericSecondQuantity. If this the priority is not set or incorrectly set, an user error will occur.
...
field to \option{GLS}. Normally, this would
be the temperature, salinity and any biology fields active.
