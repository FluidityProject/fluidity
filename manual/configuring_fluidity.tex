...
\begin{description}
\item[First Order Upwind] - see section \ref{sec:cv_fou}
...
For steady state problems the mass terms may be disabled using \option{\ldots/mass\_terms/exclude\_mass\_terms}.  Note that this also requires the suitable setting of the temporal discretisation options.
