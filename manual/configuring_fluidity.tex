...
and as such are automatically divided by the ERA40 temporal resolution. These parameters are used as input to the 
bulk forcing formulae of \citet{large2004} included in \fluidity.
