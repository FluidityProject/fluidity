...
\ref{chap:meshes}. If compiled with full libgmsh support, then for serial runs
\fluidity can read the Gmsh geometry from a \lstinline[language=bash]+.geo+ file
directly by setting the \onlypdf\option{/geometry/mesh/from\_file/format}\ option
to \onlypdf\option{gmsh}
