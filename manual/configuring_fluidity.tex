...
The output is a new flml called  foo\_periodised.flml. Then run flredecomp (section \ref{sect:flredecomp}) to decompose the mesh for the number of processors required. For example, to decompose a periodic mesh to be run on four processors simply type:
