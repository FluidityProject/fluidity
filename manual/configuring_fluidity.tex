...
\index{mesh!required}
Only the Coordinate mesh is now required by fluidity.

Only one mesh is required: the CoordinateMesh. Other meshes are strongly recommended
when using certain features of \fluidity and are described in the appropriate sections.
