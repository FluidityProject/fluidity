...
field: the SedimentBedload field. Each sediment class has its on bedload field.

Erosion of this bed can be modelled by applying the sediment\_reentrainment boundary
condition. Erosion occurs when the bed-shear stress is greater than the critical shear
