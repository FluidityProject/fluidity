...
Note that the spatial diffusion term can not be included in this version of the PBE solver and only continuous elements can be used with this code. In order to compile the population balance code with the quadrature implementation rename the file \option{DQMOM\_quad\_source.F90} to \option{DQMOM.F90} in the \option{population\_balance} directory and recompile \fluidity\.
