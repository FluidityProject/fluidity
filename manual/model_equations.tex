...
\begin{equation}
\nabla\cdot\mu\left(\nabla\bmu + (\nabla\bmu)^T\right) = \frac{\partial_i}{\partial x_j} \mu \left(\frac{\partial \bmu_i}{\partial x_j} + \frac{\bmu_j}{\partial x_i}\right) = \mu \left(\frac{\partial_i}{\partial x_j}\frac{\partial \bmu_i}{\partial x_j} + \frac{\partial_i}{\partial x_j}\frac{\bmu_j}{\partial x_i}\right) = \mu \left(\frac{\partial_i}{\partial x_j}\frac{\partial \bmu_i}{\partial x_j}\right) = \nabla\cdot\mu\nabla\bmu
\end{equation}
