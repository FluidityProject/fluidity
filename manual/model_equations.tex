...
\subsubsection{Wetting and drying}\label{Sect:WD}
\index{free surface!Wetting and drying}
If wetting and drying occurs, the free surface boundary condition \ref{freesurf3} need to be changed to ensure that the water level $\eta$ does not sink below the bathymetry level $b$:
