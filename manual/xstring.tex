...
% This is xtring.tex
%
% "xstring" package consists of the 11 following files:
...
% -------------------------------------------------------------------
\def\xstringversion     {1.5c}
\def\xstringdate        {2009/06/05}
\def\xstringfrenchdate  {5 juin 2009}
\def\xstringenglishdate {June $5^{\mathrm{th}}$ 2009}
...
\@xs@newmacro\IfDecimal{}{1}{0}{%
	...
	\ifx\@empty\@xs@afterdecimal
		\expandafter\@firstoftwo
	\else
		\expandafter\tokenize\expandafter\@xs@afterdecimal\expandafter{\@xs@afterdecimal}%
		\expandafter\@secondoftwo
	\fi}

\def\@xs@defafterinteger#1\relax\@xs@nil{\def\@xs@afterinteger{#1}}
\def\@xs@testdot{\@ifnextchar.{\@xs@readdecimalpart}{\@xs@testcomma}}
\def\@xs@testcomma{\@ifnextchar,{\@xs@readdecimalpart}{\@xs@endnumber}}
