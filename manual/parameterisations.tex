...
Multiphase version of the $k$ and $\epsilon$ equations includes a contribution from volume fraction and interphase interaction terms, as discussed in \cite{bhutani2016}. The present multiphase implementation in Fluidity neglects the interphase interaction terms.
