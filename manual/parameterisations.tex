...
\begin{equation}
\overline{u'w'} = -K_M\frac{\partial u}{\partial z},\quad
\overline{v'w'} = -K_M\frac{\partial v}{\partial z},\quad
...
of the turbulent fluctuations about mean velocity. $\nu_H^0$ is a background diffusivity, $\nu_M^0$
is a background viscosity, $S_M$ and $S_H$ are so-called \emph{stability functions},
$k$ is the turbulent kinetic energy, and $l$ is a length-scale.
...
\begin{equation}
P=-\langle u'w'\rangle\frac{\partial u}{\partial z}-\langle v'w' \rangle\frac{\partial v}{\partial z}=K_MM^2, \quad M^2=\left(\frac{\partial U}{\partial z}\right)^2 + \left(\frac{\partial V}{\partial z}\right)^2,
\end{equation}
\begin{equation}
