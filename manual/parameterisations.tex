...
an adaptive mesh, it is not always feasible to resolve all process that are
...
\section{General length scale turbulence parameterisation}\label{Sect:GLS}
...
The general length scale (GLS) turbulence parameterisation is capable of simulating vertical
...
\fluidity has four implementations of GLS available: $k-\epsilon$, $k-kl$, $k-\omega$, 
...
A lengthscale limiter has been included in the model (see \citet{yap1987, craft1996}):
