...
The multiphase version of the $k$ and $\epsilon$ equations includes a contribution from volume fraction and interphase interaction terms, as discussed by \cite{bhutani2016}. The present multiphase implementation of the $k$ and $\epsilon$ equations in Fluidity neglects the interphase interaction terms.
