...
\end{align}
Equation \eqref{eqn:defin_sgs_stress_tensor} above also introduces the Leonard decomposition
...
the viscosity model. $C_S \approx 0.1$ is the Smagorinsky coefficient.
