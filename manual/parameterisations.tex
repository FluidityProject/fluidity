...
Note that the destruction term in \ref{eq:k} and the production and destruction terms in
...
For high Reynolds numbers ($Re>10^4$), the \option{high\_Re} wall functions are
...
Throughout the above, $\gamma$ is interchangeable with any variable and
