...
\end{lstlisting}
where \texttt{name} refers to the filename of the input mesh. It options are:
\begin{lstlisting}[language = Bash]
-h   displays help
...
-v   verbose output
\end{lstlisting}
Note that the mesh format \texttt{exodusii} is only supported as an input mesh format.
