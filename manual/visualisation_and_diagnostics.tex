...
\begin{lstlisting}[language = Bash]
 ...
 -s, --static   use this flag only when a fixed mesh was used,
                by default a dynamically varying (adaptive) spatial mesh
                is assumed.
