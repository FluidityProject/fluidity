...
$P0P_{1\text{CV}}$ & This is similar to the $\Pzo$ pair but with a $P_{1\text{CV}}$ discretisation 
for pressure. This has the advantage that in the advection equation for $P_{1CV}$ tracers, the 
...
$P2P1$ & This is a well known, stable element pair (also known as Taylor Hood. It does require 
