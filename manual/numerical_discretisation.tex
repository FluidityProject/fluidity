...
\begin{equation}
  \int_v \ppt{c} +
    ...
    = 0.
\end{equation}
First order upwinding is stable in the sense of boundedness, assuming an appropriate temporal discretisation is selected.
...
As noted above, several of the face value schemes 
...
\caption{The UltraC face value scheme represented on (a) a normalised variable diagram (NVD) and (b) a modified normalised variable diagram.}
\label{fig:swebylimiter}
\end{center}
\end{figure}
