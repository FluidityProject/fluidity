...
\begin{equation}
  \sum_j \int_\Omega \phi_i \phi_j  \ddt{T_j} -
...
\begin{equation}
  \widehat{\vec{n}\cdot\vec{u}~T}=\frac{1}{2}\vec{n}\cdot\vec{\hat u}
  \left(T_{\mathrm{int}}+T_{\mathrm{ext}}\right)
  -\frac{C}{2}T_{\mathrm{int}}-T_{\mathrm{ext}}
\end{equation}
where $T_{\mathrm{ext}}$ is the value of $T$ on the exterior side of the
