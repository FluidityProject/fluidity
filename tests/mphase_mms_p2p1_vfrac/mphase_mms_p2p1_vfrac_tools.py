...
def forcing_u2(X):
    return 100.*(0.500*sin(X[0]**2 + X[1]**2) + 0.100)*X[0]*cos(X[0]**2 + X[1]**2) + (1.50*sin(X[0]**2 + X[1]**2) + 0.300)*(-0.320*X[1]*sin(0.800*X[0]*X[1]/pi)/pi - 0.540*sin(0.600*X[0]))*(0.600*sin(0.700*X[1]) + 0.400*cos(0.800*X[0]*X[1]/pi) + 0.900*cos(0.600*X[0]) + 0.900) + (1.50*sin(X[0]**2 + X[1]**2) + 0.300)*(-0.320*X[0]*sin(0.800*X[0]*X[1]/pi)/pi + 0.420*cos(0.700*X[1]))*(0.275*sin(3.00*X[0]*X[1]/pi) - 2.00*sin(7.50*X[0]) + cos(X[1]) - 1.00) - (-0.160*X[1]*sin(0.800*X[0]*X[1]/pi)/pi - 0.270*sin(0.600*X[0]))*X[0]*cos(X[0]**2 + X[1]**2) - (-0.160*X[0]*sin(0.800*X[0]*X[1]/pi)/pi + 0.210*cos(0.700*X[1]))*X[1]*cos(X[0]**2 + X[1]**2) - (0.500*sin(X[0]**2 + X[1]**2) + 0.100)*(-0.128*X[1]**2*cos(0.800*X[0]*X[1]/pi)/pi**2 - 0.162*cos(0.600*X[0])) - (0.500*sin(X[0]**2 + X[1]**2) + 0.100)*(-0.128*X[0]**2*cos(0.800*X[0]*X[1]/pi)/pi**2 - 0.147*sin(0.700*X[1])) - 1.06066017150000*sin(X[0]**2 + X[1]**2) - 0.212132034300000

def forcing_v2(X):
    return 100.*(0.500*sin(X[0]**2 + X[1]**2) + 0.100)*X[1]*cos(X[0]**2 + X[1]**2) + (1.50*sin(X[0]**2 + X[1]**2) + 0.300)*(0.825*X[1]*cos(3.00*X[0]*X[1]/pi)/pi - 15.0*cos(7.50*X[0]))*(0.600*sin(0.700*X[1]) + 0.400*cos(0.800*X[0]*X[1]/pi) + 0.900*cos(0.600*X[0]) + 0.900) + (1.50*sin(X[0]**2 + X[1]**2) + 0.300)*(0.825*X[0]*cos(3.00*X[0]*X[1]/pi)/pi - sin(X[1]))*(0.275*sin(3.00*X[0]*X[1]/pi) - 2.00*sin(7.50*X[0]) + cos(X[1]) - 1.00) - (0.412500000000000*X[1]*cos(3.00*X[0]*X[1]/pi)/pi - 7.50*cos(7.50*X[0]))*X[0]*cos(X[0]**2 + X[1]**2) - (0.412500000000000*X[0]*cos(3.00*X[0]*X[1]/pi)/pi - 0.500*sin(X[1]))*X[1]*cos(X[0]**2 + X[1]**2) - (0.500*sin(X[0]**2 + X[1]**2) + 0.100)*(-1.23750000000000*X[1]**2*sin(3.00*X[0]*X[1]/pi)/pi**2 + 56.2500000000000*sin(7.50*X[0])) - (0.500*sin(X[0]**2 + X[1]**2) + 0.100)*(-1.23750000000000*X[0]**2*sin(3.00*X[0]*X[1]/pi)/pi**2 - 0.500*cos(X[1])) - 1.06066017150000*sin(X[0]**2 + X[1]**2) - 0.212132034300000
