...
Point(2) = {0.3, 0.0, 0.0, 0.01};
Point(3) = {0.3, 0.0, 0.3, 0.01};
Point(4) = {0.0, 0.0, 0.3, 0.01};
Point(5) = {0.0, 0.7, 0.0, 0.01};
Point(6) = {0.3, 0.7, 0.0, 0.01};
Point(7) = {0.3, 0.7, 0.3, 0.01};
Point(8) = {0.0, 0.7, 0.3, 0.01};
