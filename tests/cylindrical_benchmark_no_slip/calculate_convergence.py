...
def velocity_convergence(file_coarse, file_fine):
    ...
    error_fine = (
        stat(file_fine)["Fields"]["VelocityError%magnitude"]["l2norm"][-1] / anal
    )
...
def surface_velocity_convergence(file_coarse, file_fine):
    ...
    error_fine = (
        stat(file_fine)["Fields"]["VelocityError"]["surface_l2norm%Top"][-1] / anal
    )
...
def CMB_velocity_convergence(file_coarse, file_fine):
    ...
    error_coarse = (
        stat(file_coarse)["Fields"]["VelocityError"]["surface_l2norm%Bottom"][-1] / anal
    )
    error_fine = (
        stat(file_fine)["Fields"]["VelocityError"]["surface_l2norm%Bottom"][-1] / anal
    )
...
def surface_normalstress_convergence(file_coarse, file_fine):
    ...
    error_coarse = (
        stat(file_coarse)["Fields"]["NormalStressError"]["surface_l2norm%Top"][-1]
        / anal
    )
    error_fine = (
        stat(file_fine)["Fields"]["NormalStressError"]["surface_l2norm%Top"][-1] / anal
    )
...
def CMB_normalstress_convergence(file_coarse, file_fine):
    ...
    error_coarse = (
        stat(file_coarse)["Fields"]["NormalStressError"]["surface_l2norm%Bottom"][-1]
        / anal
    )
    error_fine = (
        stat(file_fine)["Fields"]["NormalStressError"]["surface_l2norm%Bottom"][-1]
        / anal
    )
