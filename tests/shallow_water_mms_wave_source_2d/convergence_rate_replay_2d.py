...
def test_convergence_rates(tol, only_spacetime):
  ...
  statfiles = ["wave_dt_A_forward.stat", "wave_dt_B_forward.stat", "wave_dt_C_forward.stat", "wave_dt_D_forward.stat", "wave_dt_E_forward.stat"]
  res1 = test_convergence(statfiles, fields, tol)
  statfiles = ["wave_dt_dx_A_forward.stat", "wave_dt_dx_B_forward.stat", "wave_dt_dx_C_forward.stat", "wave_dt_dx_D_forward.stat", "wave_dt_dx_E_forward.stat"]
