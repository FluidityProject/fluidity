...
Stemperature1 = u1*diff(temperature1,x) + v1*diff(temperature1,y) - (_sage_const_1p0 )*(diff(temperature1, x, x) + diff(temperature1, y, y))
...
Stemperature2 = u2*diff(temperature2,x) + v2*diff(temperature2,y) - (_sage_const_1p0 )*(diff(temperature2, x, x) + diff(temperature2, y, y))
