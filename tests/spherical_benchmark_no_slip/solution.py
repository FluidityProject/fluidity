...
C_pm = 0.5*((2*l + 1)*pm*(beta/alpha)**(2*pm)/(2*l + 3) + (2*l - 1)*mp/(2*l + 1) + 2*(alpha**(-2*l - 1) - beta**(-2*l - 1))/(2*l + 1) + 4*mp*(beta/alpha)**((2*l + 1)*pm)/((2*l + 3)*(2*l + 1)) - 2*(alpha**(-2*l - 1)/beta**2 - beta**(-2*l - 1)/alpha**2)/(2*l + 3) - 1/alpha**2 + 1/beta**2)*g/(((2*l + 1)**2*(alpha**2/beta**2 + beta**2/alpha**2) - 2*(2*l + 3)*(2*l - 1) - 4*(beta/alpha)**(2*l + 1) - 4*(beta/alpha)**(-2*l - 1))*nu*rp**l)
