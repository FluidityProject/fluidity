...
def forcing_ie2(X):
    return 0.300*X[0]**2*X[1]*cos(X[0]*X[1]) - 0.200*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(2.00*X[0]*sin(X[0]**2 + X[1]**2) - 2.50)*(0.500*X[0]*X[1] + 0.400*cos(X[0] + X[1])) + 0.100*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(0.500*X[0]*X[1] + 0.400*cos(X[0] + X[1]))*X[0] + (1.50*X[0] + 0.600*cos(X[0]**2 + X[1]**2))*X[1]*cos(X[0]*X[1]) + 0.000200*X[0]**2*sin(X[0]*X[1]) + 0.000200*X[1]**2*sin(X[0]*X[1])
