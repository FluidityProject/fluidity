...
def forcing_ie1(X):
    return 1.60*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(0.500*X[0]*X[1] + 0.400*cos(X[0] + X[1]))*X[0]*cos(X[0]**2 + X[1]**2) - 0.160*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(0.500*X[0]*X[1] + 0.400*cos(X[0] + X[1]))*X[1]*sin(X[0]**2 + X[1]**2) + (0.100*cos(X[0]**2 + X[1]**2) + 0.0500)*(0.400*sin(X[0]**2 + X[1]**2) + 0.600)*(1.25*X[0] - sin(X[0] + X[1])) + (0.400*sin(X[0]**2 + X[1]**2) + 0.600)*(sin(X[0]**2 + X[1]**2) + 0.500)*(1.25*X[1] - sin(X[0] + X[1])) + 0.00205714285714286*cos(X[0] + X[1])
...
def forcing_ie2(X):
    return 0.200*X[0]**2*X[1]*cos(X[0]*X[1]) - 0.200*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(2.00*X[0]*sin(X[0]**2 + X[1]**2) - 2.50)*(0.500*X[0]*X[1] + 0.400*cos(X[0] + X[1])) + 0.100*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*(0.500*X[0]*X[1] + 0.400*cos(X[0] + X[1]))*X[0] + (1.00*X[0] + 0.400*cos(X[0]**2 + X[1]**2))*X[1]*cos(X[0]*X[1]) + 0.000257142857142857*X[0]**2*sin(X[0]*X[1]) + 0.000171428571428571*X[1]**2*sin(X[0]*X[1])
