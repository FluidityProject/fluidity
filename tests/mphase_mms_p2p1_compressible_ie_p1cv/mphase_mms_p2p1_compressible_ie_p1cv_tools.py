...
def forcing_ie1(X):
    return 1.60*(0.200*cos(X[0] + X[1]) + 0.300)*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*X[0]*cos(X[0]**2 + X[1]**2) - 0.160*(0.200*cos(X[0] + X[1]) + 0.300)*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*X[1]*sin(X[0]**2 + X[1]**2) - 0.500*(0.100*cos(X[0]**2 + X[1]**2) + 0.0500)*(0.400*sin(X[0]**2 + X[1]**2) + 0.600)*sin(X[0] + X[1]) - 0.500*(0.400*sin(X[0]**2 + X[1]**2) + 0.600)*(sin(X[0]**2 + X[1]**2) + 0.500)*sin(X[0] + X[1])
...
def forcing_ie2(X):
    return 0.400*(0.200*cos(X[0] + X[1]) + 0.300)*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*X[0]*cos(X[0]**2 + X[1]**2) - 0.0400*(0.200*cos(X[0] + X[1]) + 0.300)*(0.500*sin(X[0]**2 + X[1]**2) + 0.750)*X[1]*sin(X[0]**2 + X[1]**2) + 5.00*(0.600*sin(X[0]**2 + X[1]**2) + 0.300)*X[0]*cos(X[0]**2)
