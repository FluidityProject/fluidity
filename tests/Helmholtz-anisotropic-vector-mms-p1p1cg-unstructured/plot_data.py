...
def plot_error(name1, logfile1, name2, logfile2):
    ...
    plt.savefig("commerrorplot-vector.pdf")
    plt.savefig("commerrorplot-vector.eps")
    return
...
def plot_convergence(name1, logfile1, name2, logfile2):
    ...
    plt.savefig("errorconvplot-vector.pdf")
    plt.savefig("errorconvplot-vector.eps")
    return
...
def plot_commconv(name1, logfile1, name2, logfile2):
    ...
    plt.savefig("commconvplot-vector.pdf")
    plt.savefig("commconvplot-vector.eps")
    return
