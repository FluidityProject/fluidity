...
def B_eps(X):
    return -(0.600*sin(0.700*X[1]) + 0.400*cos(0.800*X[0]*X[1]/pi) + 0.900*cos(0.600*X[0]) + 0.900)*(3.40118361661000*X[0]*cos(1.30*X[0]*X[1]/pi)/pi + 3.40118361661000*X[1]*cos(1.30*X[0]*X[1]/pi)/pi + 1.93040151213000*sin(2.10*X[1]) - 2.16374674986000*cos(1.70*X[0]))
