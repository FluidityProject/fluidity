...
if n>1:
    ...
    C = -Ra * (R1**2*R2**(k + 3*n + 5) + R1**(k + 3*n + 5)*R2**2 - R1**(2*n + 4)*R2**(k + n + 3) - R1**(k + n + 3)*R2**(2*n + 4)) / (4*A5*(k + n + 1)*(k - n + 3))
    D = -Ra * (R1**(2*n + 4)*R2**(k + 3*n + 3) - R1**(4*n + 2)*R2**(k + n + 5) - R1**(k + n + 5)*R2**(4*n + 2) + R1**(k + 3*n + 3)*R2**(2*n + 4)) / (4*A5*(k + n + 3)*(k - n + 1))
    E =  Ra * (R1**2*R2**(k + 3*n + 3) + R1**(k + 3*n + 3)*R2**2 - R1**(2*n)*R2**(k + n + 5) - R1**(k + n + 5)*R2**(2*n)) / (4*A5*(k + n + 3)*(k - n + 1))
    F =  Ra * (R1**(2*n)*R2**(k + 3*n + 5) - R1**(4*n + 2)*R2**(k + n + 3) + R1**(k + 3*n + 5)*R2**(2*n) - R1**(k + n + 3)*R2**(4*n + 2)) / (4*A5*(k + n + 1)*(k - n + 3))

    A0 = -Ra * n / ((k + n + 3)*(k + n + 1)*(k - n + 3)*(k - n + 1))
