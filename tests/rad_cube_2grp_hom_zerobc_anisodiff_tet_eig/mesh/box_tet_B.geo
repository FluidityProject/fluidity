...
Point(2) = {len,0.0,0,res};
Point(3) = {len,len,0,res};
Point(4) = {0.0,len,0,res};
...
Point(5) = {0.0,0.0,len,res};
Point(6) = {len,0.0,len,res};
Point(7) = {len,len,len,res};
Point(8) = {0.0,len,len,res};
