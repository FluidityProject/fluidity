...
_sage_const_2 = Integer(2); _sage_const_8p2 = RealNumber('8.2'); _sage_const_1p8 = RealNumber('1.8'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_1p3 = RealNumber('1.3'); _sage_const_1p4 = RealNumber('1.4'); _sage_const_0p707106781 = RealNumber('0.707106781'); _sage_const_1p7 = RealNumber('1.7'); _sage_const_0p1 = RealNumber('0.1'); _sage_const_0p0 = RealNumber('0.0'); _sage_const_3p8 = RealNumber('3.8'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_0p4 = RealNumber('0.4'); _sage_const_0p7 = RealNumber('0.7'); _sage_const_0p6 = RealNumber('0.6'); _sage_const_0p9 = RealNumber('0.9'); _sage_const_0p8 = RealNumber('0.8'); _sage_const_3p0 = RealNumber('3.0'); _sage_const_3p7 = RealNumber('3.7'); _sage_const_2p1 = RealNumber('2.1'); _sage_const_2p5 = RealNumber('2.5'); _sage_const_5p2 = RealNumber('5.2'); _sage_const_4p3 = RealNumber('4.3')
y = var('y')
...
rho1 = function(_sage_const_5p2 , -_sage_const_1p8 , -_sage_const_1p3 , _sage_const_3p7 , 
...
ie1 = function(_sage_const_0p9 , _sage_const_0p9 , _sage_const_0p6 , _sage_const_0p4 , 
...
ie2 = function(_sage_const_8p2 , -_sage_const_3p8 , _sage_const_4p3 , _sage_const_1p7 , 
             _sage_const_1p0 , _sage_const_0p0 , _sage_const_0p0 , _sage_const_1p0 , _sage_const_1p0 , _sage_const_0p0 ,
...
u2 = cos(x**_sage_const_2 +y**_sage_const_2 )+_sage_const_2p5 *x
v2 = _sage_const_0p5 *x*y
 
gamma = _sage_const_1p4 
p = (gamma - _sage_const_1p0 )*rho1*ie1
