...
pwd = os.getenv("PWD")
print(pwd)
mydir = pwd.split("backward-facing-step-3d")[0] + "backward-facing-step-3d"
print(mydir)
...
def ercoftacvelocityprofiles():
    ...
    U19 = []
    datafile = open(
        str(mydir) + "/Ercoftac-test31-BFS/BFS-SEM-ERCOFTAC360-table.dat", "r"
    )
    for line in range(1):
        datafile.readline()
    ...
    datafile = open(
        str(mydir) + "/Ercoftac-test31-BFS/BFS-SEM-ERCOFTAC411-table.dat", "r"
    )
    for line in range(1):
        datafile.readline()
    for line in datafile:
    ...
    datafile = open(
        str(mydir) + "/Ercoftac-test31-BFS/BFS-SEM-ERCOFTAC513-table.dat", "r"
    )
    for line in range(1):
        datafile.readline()
    for line in datafile:
    ...
    datafile = open(
        str(mydir) + "/Ercoftac-test31-BFS/BFS-SEM-ERCOFTAC744-table.dat", "r"
    )
    for line in range(1):
        datafile.readline()
    for line in datafile:
...
def ercoftacrestressprofiles():
    ...
    datafile = open(
        str(mydir) + "/Ercoftac-test31-BFS/BFS-SEM-ERCOFTAC181-table.dat", "r"
    )
