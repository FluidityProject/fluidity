...
_sage_const_2 = Integer(2); _sage_const_8p9 = RealNumber('8.9'); _sage_const_10p0 = RealNumber('10.0'); _sage_const_8p2 = RealNumber('8.2'); _sage_const_1p8 = RealNumber('1.8'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_1p2 = RealNumber('1.2'); _sage_const_1p3 = RealNumber('1.3'); _sage_const_1p5 = RealNumber('1.5'); _sage_const_1p7 = RealNumber('1.7'); _sage_const_0p1 = RealNumber('0.1'); _sage_const_0p0 = RealNumber('0.0'); _sage_const_0p3 = RealNumber('0.3'); _sage_const_0p2 = RealNumber('0.2'); _sage_const_0p4 = RealNumber('0.4'); _sage_const_0p7 = RealNumber('0.7'); _sage_const_0p6 = RealNumber('0.6'); _sage_const_0p9 = RealNumber('0.9'); _sage_const_0p8 = RealNumber('0.8'); _sage_const_3p7 = RealNumber('3.7'); _sage_const_2p1 = RealNumber('2.1'); _sage_const_2p5 = RealNumber('2.5'); _sage_const_5p2 = RealNumber('5.2'); _sage_const_3p8 = RealNumber('3.8'); _sage_const_4p3 = RealNumber('4.3')
y = var('y')
...
vfrac1 = function(_sage_const_0p9 , _sage_const_0p9 , _sage_const_0p6 , _sage_const_0p4 , 
...
vfrac2 = function(_sage_const_8p2 , -_sage_const_3p8 , _sage_const_4p3 , _sage_const_1p7 , 
             _sage_const_1p0 , _sage_const_0p0 , _sage_const_0p0 , _sage_const_1p0 , _sage_const_1p0 , _sage_const_0p0 ,
...
u1 = function(_sage_const_2p5 , _sage_const_1p0 , _sage_const_0p6 , _sage_const_0p0 , 
             ...
             _sage_const_1p0 , _sage_const_1p0 , _sage_const_1p0 )
v1 = function(_sage_const_5p2 , -_sage_const_1p8 , -_sage_const_1p3 , _sage_const_3p7 , 
               _sage_const_1p0 , _sage_const_0p0 , _sage_const_0p0 , _sage_const_1p0 , _sage_const_1p0 , _sage_const_0p0 ,
               _sage_const_1p7 , _sage_const_2p1 , _sage_const_1p3 )
u2 = function(_sage_const_1p5 , -_sage_const_1p0 , _sage_const_8p9 , _sage_const_1p2 , 
             _sage_const_1p0 , _sage_const_0p0 , _sage_const_0p0 , _sage_const_1p0 , _sage_const_1p0 , _sage_const_0p0 ,
             _sage_const_0p1 , _sage_const_0p8 , _sage_const_0p3 )
             
vfrac1 = _sage_const_0p2 *x
vfrac2 = _sage_const_1p0  - (_sage_const_0p2 *x)
