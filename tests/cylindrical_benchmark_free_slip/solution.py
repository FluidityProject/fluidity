...
if n <= 1:
    raise NotImplementedError("Only implemented solutions for n>1")
...
# since the alpha's are length-2 arrays (each entry corresponding to one halve
# of the domain) so will the coefficients and thus the solution
