...
! loc_f
          ...
          DO CV_KLOC = 1, CV_NLOC
             ...
             IPT=1
             CALL PACK_OR_UNPACK_LOC( LOC_F(:, CV_KLOC), T_ALL( :, CV_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(1), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_F(:, CV_KLOC), TOLD_ALL( :, CV_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(2), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_F(:, CV_KLOC), DEN_ALL( :, CV_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(3), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_F(:, CV_KLOC), DENOLD_ALL( :, CV_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(4), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_F(:, CV_KLOC), T2_ALL( :, CV_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(5), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_F(:, CV_KLOC), T2OLD_ALL( :, CV_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(6), GLOBAL_FACE )
! for FEM variables...
             IPT=1
             CALL PACK_OR_UNPACK_LOC( LOC_FEMF(:, CV_KLOC), FEMT_ALL( :, CV_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(1), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_FEMF(:, CV_KLOC), FEMTOLD_ALL( :, CV_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(2), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_FEMF(:, CV_KLOC), FEMDEN_ALL( :, CV_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(3), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_FEMF(:, CV_KLOC), FEMDENOLD_ALL( :, CV_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(4), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_FEMF(:, CV_KLOC), FEMT2_ALL( :, CV_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(5), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( LOC_FEMF(:, CV_KLOC), FEMT2OLD_ALL( :, CV_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(6), GLOBAL_FACE )
          END DO
...
! loc_u
          DO U_KLOC = 1, U_NLOC
             ...
             DO IDIM=1,NDIM 
                IPT=1
                CALL PACK_OR_UNPACK_LOC( LOC_U(IDIM, :, U_KLOC),          U_ALL( IDIM, :, U_NODK ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_U_ALL(1), GLOBAL_FACE )
             END DO
             DO IDIM=1,NDIM
                IPT=1+NPHASE
                CALL PACK_OR_UNPACK_LOC( LOC_U(IDIM, :, U_KLOC), NUOLD_ALL( IDIM, :, U_NODK ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_U_ALL(2), GLOBAL_FACE )
             END DO
          END DO
! Generate some local F variables ***************...
! 
...
!          ENDIF
          IF( (ELE2 > 0) .OR. (SELE /= 0) ) THEN
             ...
             IPT=1
             CALL PACK_OR_UNPACK_LOC( SLOC2_F(:, CV_KLOC), T_ALL( :, CV_NODK2 ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(1), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_F(:, CV_KLOC), TOLD_ALL( :, CV_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(2), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_F(:, CV_KLOC), DEN_ALL( :, CV_NODK2 ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(3), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_F(:, CV_KLOC), DENOLD_ALL( :, CV_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(4), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_F(:, CV_KLOC), T2_ALL( :, CV_NODK2 ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(5), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_F(:, CV_KLOC), T2OLD_ALL( :, CV_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(6), GLOBAL_FACE )
! fem:
             IPT=1
             CALL PACK_OR_UNPACK_LOC( SLOC2_FEMF(:, CV_KLOC), FEMT_ALL( :, CV_NODK2 ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(1), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_FEMF(:, CV_KLOC), FEMTOLD_ALL( :, CV_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(2), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_FEMF(:, CV_KLOC), FEMDEN_ALL( :, CV_NODK2 ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(3), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_FEMF(:, CV_KLOC), FEMDENOLD_ALL( :, CV_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(4), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_FEMF(:, CV_KLOC), FEMT2_ALL( :, CV_NODK2 ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(5), GLOBAL_FACE )
             CALL PACK_OR_UNPACK_LOC( SLOC2_FEMF(:, CV_KLOC), FEMT2OLD_ALL( :, CV_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(6), GLOBAL_FACE )
             ...
             DO U_SKLOC = 1, U_SNLOC
                ...
                IF(ELE2>0) THEN
                   ...
                   DO IDIM=1,NDIM
                      IPT=1
                      CALL PACK_OR_UNPACK_LOC( SLOC_U(IDIM, :, U_SKLOC),   U_ALL( IDIM, :, U_NODK2 ),   NPHASE, NFIELD, IPT, PACK, STORE, IGOT_U_ALL(1), GLOBAL_FACE)
                   END DO
                   DO IDIM=1,NDIM
                      IPT=1+NPHASE
                      CALL PACK_OR_UNPACK_LOC( SLOC_U(IDIM, :, U_SKLOC), NUOLD_ALL( IDIM, :, U_NODK2 ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_U_ALL(2), GLOBAL_FACE)
                   END DO
                ELSE
...
! Pack ndotq information: 
             IPT=1
             CALL PACK_OR_UNPACK_LOC( F_INCOME(:), INCOME( : ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(1), GLOBAL_FACE ) ! t
             CALL PACK_OR_UNPACK_LOC( F_INCOME(:), INCOMEOLD( : ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(2), GLOBAL_FACE ) ! TOLD
             CALL PACK_OR_UNPACK_LOC( F_INCOME(:), INCOME( : ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(3), GLOBAL_FACE )  ! d
             CALL PACK_OR_UNPACK_LOC( F_INCOME(:), INCOMEOLD( : ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(4), GLOBAL_FACE )  ! DOLD
             CALL PACK_OR_UNPACK_LOC( F_INCOME(:), INCOME( : ),    NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(5), GLOBAL_FACE )  ! T2
             CALL PACK_OR_UNPACK_LOC( F_INCOME(:), INCOMEOLD( : ), NPHASE, NFIELD, IPT, PACK, STORE, IGOT_T_ALL(6), GLOBAL_FACE )  ! T2OLD
             IPT=1
