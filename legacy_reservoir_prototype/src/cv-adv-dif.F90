...
!           DENOLDUPWIND_MAT, T2UPWIND_MAT, T2OLDUPWIND_MAT
      ...
      REAL , DIMENSION( :, :, :, : ), ALLOCATABLE :: INV_G_OPT_VEL_UPWIND_COEFS
      REAL :: BCZERO(NPHASE) 
...
! FOR packing as well as for detemining which variables to apply interface tracking**********
           ...
           IF ( IS_OVERLAPPING .or. is_compact_overlapping ) THEN
               ...
               IF( is_compact_overlapping ) THEN ! The inverse of the sigma matrix...
                  ALLOCATE( INV_G_OPT_VEL_UPWIND_COEFS(NDIM,NDIM,NPHASE,MAT_NONODS) ) 
                  ...
                  DO MAT_NODI=1,MAT_NONODS
                     ...
                     END DO
                     INV_G_OPT_VEL_UPWIND_COEFS(:,:,:,MAT_NODI)=INV_GI_LOC_OPT_VEL_UPWIND_COEFS(:,:,:)
                  END DO
...
! Generate some local F variables ***************
            ...
            IF ( IS_OVERLAPPING .or. is_compact_overlapping ) THEN
               ...
               END DO
               IF( is_compact_overlapping ) THEN ! The inverse of the sigma matrix...
                  INV_GI_LOC_OPT_VEL_UPWIND_COEFS(:,:,:) = INV_G_OPT_VEL_UPWIND_COEFS(:,:,:,MAT_NODI) 
               ENDIF
...
!------------------
       ...
       END IF If_GOT_DIFFUS2
                   ...
                   IF ( IS_OVERLAPPING.or. is_compact_overlapping ) THEN
                      ...
                      END DO
                      IF( is_compact_overlapping ) THEN ! The inverse of the sigma matrix...
                         INV_GJ_LOC_OPT_VEL_UPWIND_COEFS(:,:,:) = INV_G_OPT_VEL_UPWIND_COEFS(:,:,:,MAT_NODJ) 
                      ENDIF
...
! 
  ...
  SUBROUTINE GET_INT_VEL_NEW( NPHASE, NDOTQNEW, NDOTQ,INCOME, &
    ...
    REAL, DIMENSION( :, :, : ), intent( in ) :: INV_GI_LOC_OPT_VEL_UPWIND_COEFS, INV_GJ_LOC_OPT_VEL_UPWIND_COEFS
