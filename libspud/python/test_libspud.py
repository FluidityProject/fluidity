...
assert (
    libspud.get_option_rank(
        "/physical_parameters/gravity/vector_field::GravityDirection"
        "/prescribed/value/constant"
    )
    == 1
)
...
tensor_path = (
    "/material_phase::Material1/tensor_field::DummyTensor/"
    "prescribed/value::WholeMesh/anisotropic_asymmetric/constant"
)
