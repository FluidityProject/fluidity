...
for plugin in plugin_dirs:
  if prefix is None:
    plugin_data_files.append(("/data/code_development/GitHub_projects/darcy_on_the_way/libspud/../share/diamond/plugins/" + plugin,
...
gui_data_files = []
if prefix is None:
  gui_data_files.append(("/data/code_development/GitHub_projects/darcy_on_the_way/libspud/../share/diamond/gui",
