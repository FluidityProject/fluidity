...
for plugin in plugin_dirs:
  if prefix is None:
    plugin_data_files.append(("/data/src/fluidity/ROM_DA_DEIM_2/libspud/../share/diamond/plugins/" + plugin,
...
gui_data_files = []
if prefix is None:
  gui_data_files.append(("/data/src/fluidity/ROM_DA_DEIM_2/libspud/../share/diamond/gui",
