...
subroutine test_vector_spherical_polar_2_cartesian
  ...
  do node=1,node_count(URVdifference)
    ...
    vector_components_polar = node_val(UnitRadialVector_inPolar, node)
    call vector_spherical_polar_2_cartesian(vector_components_polar(1), &
                                            vector_components_polar(2), &
                                            vector_components_polar(3), &
                                            RTP(1), RTP(2), RTP(3), &
                                            vector_components_cartesian(1), &
                                            vector_components_cartesian(2), &
                                            vector_components_cartesian(3), &
                                            XYZ(1), XYZ(2), XYZ(3))
    call set(URVdifference, node, vector_components_cartesian)
  enddo
  call addto(URVdifference, UnitRadialVector_inCartesian, -1.0)
  ...
  do node=1,node_count(UPVdifference)
    RTP = node_val(PolarCoordinate, node)
    vector_components_polar = node_val(UnitPolarVector_inPolar, node)
    call vector_spherical_polar_2_cartesian(vector_components_polar(1), &
                                            vector_components_polar(2), &
                                            vector_components_polar(3), &
                                            RTP(1), RTP(2), RTP(3), &
                                            ...
                                            vector_components_cartesian(3), &
                                            XYZ(1), XYZ(2), XYZ(3))
    call set(UPVdifference, node, vector_components_cartesian)
  enddo
  call addto(UPVdifference, UnitPolarVector_inCartesian, -1.0)
  ...
  do node=1,node_count(UAVdifference)
    RTP = node_val(PolarCoordinate, node)
    vector_components_polar = node_val(UnitAzimuthalVector_inPolar, node)
    call vector_spherical_polar_2_cartesian(vector_components_polar(1), &
                                            vector_components_polar(2), &
                                            vector_components_polar(3), &
                                            RTP(1), RTP(2), RTP(3), &
                                            ...
                                            vector_components_cartesian(3), &
                                            XYZ(1), XYZ(2), XYZ(3))
    call set(UAVdifference, node, vector_components_cartesian)
  enddo
  call addto(UAVdifference, UnitAzimuthalVector_inCartesian, -1.0)
