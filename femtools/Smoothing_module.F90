...
module smoothing_module
  ...
  public :: smooth_scalar, smooth_vector, anisotropic_smooth_scalar, anisotropic_smooth_vector
  ...
  subroutine assemble_anisotropic_smooth_scalar(M, rhsfield, positions, field_in, alpha, ele)
    ...
    beta=1.0/24.0
    mesh_tensor_quad = alpha*beta*les_length_scale_tensor(dshape_field_in, shape_field_in)
