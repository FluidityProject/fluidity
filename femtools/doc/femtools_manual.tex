...
A number of routiens have been implemented in \lstinline{femtools/Coordinates.F90}
that can be used for coordinate transformations and vector/tensor change of basis.
The transformation routines also feature C-iter-operable routines so that the
...
\subsection{Spherical-polar to Cartesian}
...
\subsection{Cartesian to Spherical-polar}
