...
void python_add_array_double_1d(double *arr, int *size, char *name){
  ...
  // Set the array
  PyObject *a = PyArray_FromDimsAndData(1, (int[]){*size}, PyArray_DOUBLE, (char*)arr);
...
void python_add_array_double_2d(double *arr, int *sizex, int *sizey, char *name){
  ...
  // Set the array
  int dims[] = {*sizey,*sizex};
  PyObject *a = PyArray_FromDimsAndData(2, dims, PyArray_DOUBLE, (char*)arr);
  PyDict_SetItemString(pDict,name,a);
  char c[200];
...
void python_add_array_double_3d(double *arr, int *sizex, int *sizey, int *sizez, char *name){
  ...
  // Set the array
  int dims[] = {*sizez,*sizey,*sizex};
  PyObject *a = PyArray_FromDimsAndData(3, dims, PyArray_DOUBLE, (char*)arr);
  PyDict_SetItemString(pDict,name,a);
  char c[200];
...
void python_add_array_integer_1d(int *arr, int *size, char *name){
  ...
  // Set the array
  PyObject *a = PyArray_FromDimsAndData(1, (int[]){*size}, PyArray_INT, (char*)arr);
  PyDict_SetItemString(pDict,name,a);
  Py_DECREF(a);
#endif
}
...
void python_add_array_integer_2d(int *arr, int *sizex, int *sizey, char *name){
  ...
  // Set the array
  int dims[] = {*sizey,*sizex};
  PyObject *a = PyArray_FromDimsAndData(2, dims, PyArray_INT, (char*)arr);
  PyDict_SetItemString(pDict,name,a);
  char c[200];
  sprintf(c,"%s = numpy.transpose(%s,(1,0))",name,name);
  PyRun_SimpleString(c);
...
void python_add_array_integer_3d(int *arr, int *sizex, int *sizey, int *sizez, char *name){
  ...
  // Set the array
  int dims[] = {*sizez,*sizey,*sizex};
  PyObject *a = PyArray_FromDimsAndData(3, dims, PyArray_INT, (char*)arr);
  PyDict_SetItemString(pDict,name,a);
  char c[200];
  sprintf(c,"%s = numpy.transpose(%s,(2,1,0))",name,name);
  PyRun_SimpleString(c);
