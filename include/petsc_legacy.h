...
#if (PETSC_VERSION_MAJOR==3 && PETSC_VERSION_MINOR<5) || (PETSC_VERSION_MAJOR<=2)
...
#endif
#if (PETSC_VERSION_MAJOR==3 && PETSC_VERSION_MINOR<6) || (PETSC_VERSION_MAJOR<=2)
...
#if (PETSC_VERSION_MAJOR==3 && PETSC_VERSION_MINOR<7) || (PETSC_VERSION_MAJOR<=2)
...
#if (PETSC_VERSION_MAJOR==3 && PETSC_VERSION_MINOR<8) || (PETSC_VERSION_MAJOR<=2)
