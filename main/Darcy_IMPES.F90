            ...
            do f = 1, option_count('/material_phase['//int2str(p-1)//']/scalar_field')
               ...
               if (have_option('/material_phase['//int2str(p-1)//']/scalar_field['//int2str(f-1)//']/prognostic')) then
                  ...
                  if ((trim(tmp_char_option) /= 'Pressure') .and. &
                     ...
                     !***************lcai********************************************
                     if (have_option('/material_phase['//int2str(p-1)//']/scalar_field['//int2str(f-1)//']/prognostic/tensor_field::Diffusivity/diagnostic/algorithm::Internal')) then
                        di%generic_prog_sfield(f_count)%MIM%if_dynamic_D=.true.
                     else 
                        di%generic_prog_sfield(f_count)%MIM%if_dynamic_D=.false.
                     end if
                     !*******************************************************************
